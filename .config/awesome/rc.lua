...
local liveruler = require("liveruler")
...
awful.util.mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    separator,
                                    { "open terminal", terminal, term_icon },
                                    separator,
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "s",  liveruler.save                     ,
              {description = "liverule save", group = "client"}),
...
awful.rules.rules = {
    ...
    { rule_any = { type = { "dialog", "normal" } },
      properties = { titlebars_enabled = true, focus = false } },
